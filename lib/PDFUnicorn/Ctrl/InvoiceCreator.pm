...
sub pdf{
    ...
    my $data = {
        invoice => {
            ...
            payment_due_date => $params->{invoice_payment_due_date},
            currency => $params->{currency},
            total => $params->{invoice_total},
            sub_total => $params->{invoice_subtotal},
            tax_amount => $params->{invoice_tax_subtotal},
            tax_name => $params->{invoice_tax_name},
            purchase_order => $params->{invoice_purchase_order},
            title => $params->{invoice_title},
            tax_id_name => $params->{invoice_tax_id_name},
            sender_tax_id => $params->{invoice_sender_tax_id},
            recipient_tax_id => $params->{invoice_recipient_tax_id},
